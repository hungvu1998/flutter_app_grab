...
import 'package:flutter_app_grab/src/resources/register_page.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Container(
        ...
        constraints: BoxConstraints.expand(),//max màn hình
         child: SingleChildScrollView(
           child: Column(
            children: <Widget>[
              ...
              Text("Login to continue uing iCar",style: TextStyle(
